...
// ActuatorEffort typed command를 hardware command interface 로 옮기는 chainable controller.
...
private:
  ...
  rclcpp::Subscription<aidin_hand2_msgs::msg::ActuatorEffortCommand>::SharedPtr command_subscriber_;
};
